...
-s /share/inspurStorage/home3/ZXMGroup/VIROME/G3compare/pipeline/bin_label_and_evaluate/bin3C_split${splitsize}_Snakefile \
--configfile ${configdir}/${sample}_config.yaml \
--restart-times 0 --keep-going --cores 8 --latency-wait 100 --rerun-incomplete
