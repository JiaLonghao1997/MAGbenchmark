...
def run(workdir,configfile, genomesize1, genomesize2, bigcontiglength,assembler,sample, seqmethod):
    infile1="{}/{}_{}_{}/1.assemble/assemble_{}/{}_{}.contigs.fasta".format(workdir,sample, genomesize1, genomesize2,
                                                                            genomesize1, sample, genomesize1)
    ...
    if os.path.exists(infile1):
        os.system("mv {} {}".format(infile1, outfile1))

    infile2 = "{}/{}_{}_{}/1.assemble/assemble_{}/{}_{}.contigs.fasta".format(workdir, sample, genomesize1, genomesize2,
                                                                              genomesize2, sample, genomesize2)
    ...
    if os.path.exists(infile2):
        os.system("mv {} {}".format(infile2, outfile2))
...
def main():
    ...
    for sample in samples:
        ...
        if assembler == 'canu':
            ...
            filename_txt.write(
                "{}_{}_{}".format(sample, genomesize1, genomesize2) + "\t" + input + "\t" + reads1 + ',' + reads2)
            filename_txt.close()
            ...
            os.system("sed 's#file_names_path#{}#g' {} | sed 's#100m,250m#{},{}#g' | sed s/flye/canu/g > {}".format(
                filename_txt_str, sourceconfig, genomesize1, genomesize2, configfile))
            pool.apply_async(func=run, args=(
            workdir, configfile, genomesize1, genomesize2, bigcontiglength, assembler, sample, seqmethod,))
